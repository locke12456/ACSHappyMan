...
local Novel001 = GameMain:GetMod("Novel_001");

function Novel001:Init()	
	self.text_list = nil
end
function Novel001:InitRoles( player, target, target2, target3, ntr )
	self.text_list = {
	...
	self.Count = #self.text_list
end
function Novel001:GetNovel(index)
	local text = ""
